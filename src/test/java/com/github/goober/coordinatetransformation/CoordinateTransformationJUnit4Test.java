...
public class CoordinateTransformationJUnit4Test {
    ...
    public void testRT90ToWGS84() {
        ...
        assertEquals(latFromHitta, lat,0.00001d);
        assertEquals(lonFromHitta, lon,0.00001d);
        ...
        assertEquals(latDmsStringFromLM, wgsPos.latitudeToString(WGS84Position.WGS84Format.DegreesMinutesSeconds));
        assertEquals(lonDmsStringFromLM, wgsPos.longitudeToString(WGS84Position.WGS84Format.DegreesMinutesSeconds));
    }
    ...
    public void testWGS84ToRT90() {
        ...
        assertEquals(lat, xPosFromLM,0.0001d);
        assertEquals(lon, yPosFromLM,0.0001d);
    }
    ...
    public void testWGS84Parse() {
        ...
        assertEquals(62.176, lat,0.0001d);
        assertEquals(15.903, lon,0.0001d);
        ...
        assertEquals(62.176, lat_s,0.0001d);
        assertEquals(15.903, lon_s,0.0001d);
    }
}
